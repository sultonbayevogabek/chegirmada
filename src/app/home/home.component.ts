...
@Component({
  ...
  standalone: true,
  imports: [ HeaderComponent, IntroBannerComponent, CategoriesCarouselComponent, ProductsSectionComponent, BannerComponent, PartnersComponent, DownloadAppComponent ]
})
